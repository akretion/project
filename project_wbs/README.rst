...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:82f97c0c73bd1c7854ceefa64a1c2a0725e81d2769260cdeca65b80dcbed3c1d
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fproject-lightgray.png?logo=github
    :target: https://github.com/OCA/project/tree/16.0/project_wbs
    :alt: OCA/project
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/project-16-0/project-16-0-project_wbs
...
#. Go to Childs Projects to create a new child

Navigation:

* The Level column indicates the hierarchy: '1' means it is the parent, '2' means it is a child, '3' means it is a grandchild, etc.
...
`feedback <https://github.com/OCA/project/issues/new?body=module:%20project_wbs%0Aversion:%2016.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/project <https://github.com/OCA/project/tree/16.0/project_wbs>`_ project on GitHub.
